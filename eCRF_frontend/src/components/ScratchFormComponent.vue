    ...
    <div class="scratch-form-content">
      ...
      <div class="form-area">
        ...
        <div class="form-actions" v-show="!showMatrix">
          ...
          <button @click="navigateToSavedForms" class="btn-option">
            View Saved Template
          </button>
    ...
    async saveForm() {
      ...
      const payload = {
        study_metadata: {
          ...
          study_name: this.studyDetails.name || "Untitled",
        ...
        study_content: {
          study_data: {
            meta_info: {
              ...
              numberOfForms: this.studyDetails.numberOfForms,
              numberOfVisits: this.studyDetails.visits?.length,
              numberOfSubjects: this.studyDetails.participants
            },
            forms: this.forms.map(f => ({
      ...
      try {
        ...
        this.openGenericDialog("Failed to save study.");
      }
    },
